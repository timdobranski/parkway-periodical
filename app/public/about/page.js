      ...
      <div className='post'>
        ...
        <div className='pageTitleWrapper'>
          ...
          <p >{`Welcome to the Parkway Periodical! You've made it to the official parent & community newsletter for
            Parkway Health & Sciences Academy. We're glad you're here! Click below for more info about us:`}</p>

          <div className={styles.sectionWrapper}>
            <Link href='/public/electives' className={styles.link}>
              <h3 className='smallerPostTitle'>ELECTIVES</h3>
            </Link>
            <p className='noMargin'>Click here to learn more about our amazing student elective courses</p>
          </div>
          <div className={styles.sectionWrapper}>
